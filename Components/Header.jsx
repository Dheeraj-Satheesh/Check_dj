  ...
  return (
    <div className='py-5 px-5 md:px-12 lg:px-28'>
      ...
      <div className='text-center my-8'>
        ...
        Explore a world of insightful articles and trending topics on our blogging platform. Stay informed by subscribing to receive the latest updates and exclusive content directly to your inbox
        </p>
